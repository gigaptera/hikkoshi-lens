      ...
      <main className="mx-auto max-w-5xl px-4 py-8 grid gap-6 mt-16">
        ...
        <div className="flex flex-col gap-6 md:grid md:grid-cols-5">
          ...
          <aside className="md:col-span-2">
            <Card className="rounded-none h-full shadow-sm">
              <CardHeader>
                  ...
                  >
                    ...
                    <div className="col-span-3">
                      <input
                        ...
                        className="w-full h-2 bg-neutral-200 rounded-none appearance-none cursor-pointer dark:bg-neutral-700 accent-primary-600"
                      />
                    </div>
