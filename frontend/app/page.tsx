...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-primary-50/30">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-8 pb-12 px-4 md:px-6">
      ...
      <section
        id="features"
        className="py-12 bg-white border-y border-border px-4 md:px-6"
      >
      ...
      {/* How to Use */}
      <section id="how" className="py-12 bg-neutral-50 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <Badge variant="secondary" className="mb-4">
              HOW TO USE
      ...
      {/* CTA Bottom */}
      <section className="py-12 bg-gradient-to-br from-primary to-teal-700 text-white px-4 md:px-6">
